...
%		\end{itemize}
	...
	\begin{spunto}[Proprietà di finitezza (Compattezza, Connessione, Irriducibilità)]
		...
		\end{enumerate}
                Poi L.P. ed U.P. mi riportano il seguente lemma: Se $A$ è uno spazio polacco, allora $\pi: A \times X \rar X$ proiezione è tale che immagine di misurabili è misurabile, che è particolarmente simile a quanto succede con le varietà proiettive (che sono universalmente chiuse).
